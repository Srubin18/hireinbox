...
export default function TalentMappingPage() {
  ...
  const handleDraftOutreach = (candidate: MappedCandidate) => {
...
I'm working with a client who is looking for a Finance Manager in ${candidate.location}, and I believe your background could be an excellent fit.
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#0f172a' }}>Draft Outreach</h3>
              <button
