...
// ============================================
// HIREINBOX B2C - ONE PAGE CV SCANNER
// Upload CV → Get Results (no extra pages)
// ============================================
      ...
      <div style={{
        ...
        >
          ...
          {file ? (
            ...
            <>
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="1.5" style={{ margin: '0 auto 12px', display: 'block' }}>
